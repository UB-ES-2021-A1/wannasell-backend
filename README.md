...
In order to package your dependencies locally with `serverless-python-requirements`, you need to have `Python3.7` installed locally. You can create and activate a dedicated virtual environment with the following command:
...
The backend is made to work with the Serverless Framework dashboard, which includes advanced features such as CI/CD, 
...
Don't forget to export the AWS credentials to authenticate
